...
values ('Pizza Romano', 'Standard', 6.70, 'Tomato sauce, mozzarella, rosemary, semolina',1, '/img/marherita.png'),
       ('Quattro Formaggi', 'Large', 11.30, 'Mozzarella, gorgonzola, fontina, parmiggiano',2, '/img/quattro_formagi.png'),
       ('Pizza Calzone', 'Standard', 7.65, 'Tomato sauce, pepperoni, ricotta',3, '/img/hawaii.png'),
       ('Pizza Hawaii', 'Family', 13.80, 'Tomato sauce, bacon, mozzarella, pineapple',1,'/img/marherita.png'),
       ('Pizza Zucchini', 'Lage', 8.30, 'Tomato sauce, zucchini, onions',2,'/img/marherita.png'),
       ('Pizza Carbonara', 'Lage', 9.29, 'Tomato sauce, bacon, garlic, onions, mushrooms',3,'/img/marherita.png'),
       ('Pizza Napoletana', 'XL', 8.49, 'Tomato sauce, mozzarella, basil',1,'/img/marherita.png');
